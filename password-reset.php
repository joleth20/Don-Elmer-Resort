...
<head>
    <meta charset="utf-8">
    <title>Don Elmer's - Reset Password</title>
                        ...
                        <div class="p-3" style="max-width: 770px;;">
                            <section class="wrapper">
                                <form action="password-reset-code.php" method="post">
                                    <h2 class="fw-bolder pb-3 animated slideInDown">Reset Password</h2>
                                    <div class="credentials  wow fadeIn" data-wow-delay="0.1s">
                                        ...
                                        <button type="submit" name="password_reset_link"
                                            class="btn btn-dark text-center  w-100 mb-2">Send Link</button>
                                    </div>
                                    <div class="mt-4 d-flex justify-content-center">
                                            <a href="log-in.php" style="color:#fff;">Back</a>
                                        </div>
                                </form>
