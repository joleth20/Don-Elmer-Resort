...
if(isset($_POST['delete_btn'])) {
    ...
    if($query_run) {
        $_SESSION['status'] = "Your Reservation Approved has been Deleted!";
...
$total_pages_query = "SELECT COUNT(*) FROM reservations WHERE status = 'Pending' AND user_id = '$currentUser'";
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        $total_pages_query = "SELECT COUNT(*) FROM reservations WHERE status = 'Approved' AND user_id = '$currentUser'";
        $total_pages_result = mysqli_query($con, $total_pages_query);
        $total_records = mysqli_fetch_array($total_pages_result)[0];
        $total_pages = ceil($total_records / $records_per_page);
        ...
        $query = "SELECT * FROM reservations WHERE status = 'Approved' AND user_id = '$currentUser' ORDER BY $column $sort LIMIT $offset, $records_per_page";
