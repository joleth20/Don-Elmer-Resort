...
if(isset($_POST['delete_btn'])) {
    ...
    if($query_run) {
        $_SESSION['status'] = "Your Pending Reservation has been Canceled!";
...
<div class="container-fluid">
    ...
    $query = "SELECT * FROM reservations WHERE status = 'Pending' AND user_id = '$currentUser' ORDER BY $column $sort LIMIT $offset, $records_per_page";
