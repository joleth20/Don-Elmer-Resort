    ...
    <div class="card shadow mb-4">
        ...
        if(isset($_POST['approved_btn']))
        {
            ...
            <label for="Lastname" class="form-label">Phone No.</label>
                                    <input type="text"  value="<?php echo $row['number']  ?>"  class="form-control text-capitalize" name="edit_lastname"
                                        id="lastname" placeholder="Enter your last name" readonly>
            </div>
            <div class="form-group">
            <label for="number" class="form-label">Customer ID</label>
                                    <input type="number"  value="<?php echo $row['user_id']  ?>"  class="form-control text-capitalize" name="edit_number"
                                        id="number" placeholder="Phone No." readonly>
            </div>
            <div class="form-group">
            <label for="Email" class="form-label">Check in Date</label>
                                    <input type="email"  value="<?php echo $row['DATE']  ?>"  class="form-control" name="edit_email" id="Email"
                                        placeholder="Email" readonly>
            </div>

            <label for="Email" class="form-label">Check out Date</label>
            <div class="form-group-pass">
            <input type="text"  value="<?php echo $row['check_out_date']  ?>"  class="form-control" name="edit_password" id="password" placeholder="password"  readonly>   
        </div>
        <br>
        ...
        <br>
        <a href="approved.php" class="btn btn-danger"> BACK </a>
        </div>
        ...
        <h3>Payment</h3>
            ...
            <label for="Lastname" class="form-label">Payment Method</label>
                                    <input type="text"  value="<?php echo $row['paymentMethod']  ?>"  class="form-control text-capitalize" name="edit_lastname"
                                        id="lastname" placeholder="Enter your last name" readonly>
            </div>
            <div class="form-group">
            <label for="number" class="form-label">Reference Number</label>
                                    <input type="number"  value="<?php echo $row['referenceNumber']  ?>"  class="form-control text-capitalize" name="edit_number"
                                        id="number" placeholder="Phone No." readonly>
            </div>
            <label for="Email" class="form-label">Accomodation Type</label>
            <div class="form-group-pass">
            <input type="text"  value="<?php echo $row['accommodationType']  ?>"  class="form-control" name="edit_password" id="password" placeholder="password"  readonly>   
        </div>
     ...
     <div class="form-group">
            ...
            <br>
            <img src="upload/<?php echo $row['imageProof']; ?>" alt="image" width="450px;" height="450px;">
            </div>
     </div>
