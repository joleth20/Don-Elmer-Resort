...
<head>
    <meta charset="utf-8">
    <title>Don Elmer's - Change Password</title>
                ...
                <div class="col-lg-9">
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        <a href="index.html" class="navbar-brand d-block d-lg-none">
                            <h1 class="m-0 text-primary text-uppercase">Don Elmer Resort</h1>
                        </a>
                        ...
                        <div class="p-3" style="max-width: 770px;;">
                            <section class="wrapper">
                                <form action="password-reset-code.php" method="post">
                                    <h2 class="fw-bolder pb-3 animated slideInDown">Change Password</h2>
                                    <div class="credentials  wow fadeIn" data-wow-delay="0.1s">

                                        <input readonly type="hidden" name="password_token" value="<?php if (isset($_GET['token'])) {
                                                                                                echo $_GET['token'];
                                                                                            } ?>">

                                        <div class="mb-2 ">
                                        <input type="text" class="form-control" name="role" id="roleInput" aria-label="Role to login" value="<?php if (isset($_GET['role'])) { echo htmlspecialchars($_GET['role']); } ?>" readonly>
                                        </div>

                                        <div class="mb-2">
                                            <input readonly class="form-control" name="email" value="<?php if (isset($_GET['email'])) {
                                                                                                echo $_GET['email'];
                                                                                            } ?>" id="inputEmail"
                                    ...
                                    <img src="img/eye-close.png" alt=""  id="eyeicon" style="height:25px; width:34px; margin:-45px 200px; ">
                                        </div>

                                        <div class="mb-2">
                                        <input type="password" class="form-control" name="cpassword" id="cpassword" placeholder="Confirm your Password" >
                                    <img src="img/eye-close.png" alt=""  id="eyeicons" style="height:25px; width:34px; margin:-45px 200px; ">
                                        </div>

                                        <button type="submit" name="password_update"
                                            class="btn btn-dark text-center  w-100 mb-2">Update
                                            Password</button>
                                    </div>
                                </form>
