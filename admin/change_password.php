...
if (isset($_POST['updatepass'])) {
    $admin_id = $_POST['edit_pass'];
    $current_password = $_POST['current_password'];
    $new_password = $_POST['new_password'];
    $cpassword = $_POST['cpassword'];

    // Check if the current password matches
    $current_password_query = "SELECT * FROM admin WHERE admin_id='$admin_id'";
    ...
    // Update the admin table with the new hashed password
...
$row = $admin_id->fetch_assoc();
   ?>
    ...
    <input type="hidden" name="edit_pass" value="<?php echo $row['admin_id']; ?>">
